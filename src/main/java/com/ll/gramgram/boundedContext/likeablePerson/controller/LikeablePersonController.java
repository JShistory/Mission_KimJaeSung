...
public class LikeablePersonController {
    ...
    public String add(@Valid AddForm addForm) {
        RsData<LikeablePerson> createRsData = likeablePersonService.like(rq.getMember(), addForm.getUsername(),
                addForm.getAttractiveTypeCode(), rq);
...
//        RsData<LikeablePerson> deleteRsData = likeablePersonService.delete(rq.getMember(),number);
//
//        if (deleteRsData.isFail()) {
//            return rq.historyBack(deleteRsData);
//        }
